 ...
 *         &lt;element name="rr" type="{http://webservices.maplink2.com.br}ResultRange"/>
...
@XmlRootElement(name = "findDistrict")
public class FindDistrict {

    @XmlElement(required = true)
    protected District district;
    @XmlElement(required = true)
    protected ResultRange rr;
     ...
     *     
     */
    public void setRr(ResultRange value) {
        this.rr = value;
    }
